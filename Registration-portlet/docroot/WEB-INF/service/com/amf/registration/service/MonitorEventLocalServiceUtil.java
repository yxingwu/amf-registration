 ...
 * {@link com.amf.registration.service.impl.MonitorEventLocalServiceImpl} and is the
 ...
 * @see com.amf.registration.service.base.MonitorEventLocalServiceBaseImpl
...
public class MonitorEventLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.amf.registration.service.impl.MonitorEventLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.amf.registration.model.MonitorEvent addMonitorEvent(
	...
	*/
	public static com.amf.registration.model.MonitorEvent createMonitorEvent(
		long eventId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.amf.registration.model.MonitorEvent deleteMonitorEvent(
		long eventId)
	...
	*/
	...
	public static com.amf.registration.model.MonitorEvent fetchMonitorEvent(
		long eventId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.amf.registration.model.MonitorEvent getMonitorEvent(
		long eventId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.amf.registration.model.MonitorEvent> getMonitorEvents(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.amf.registration.model.MonitorEvent updateMonitorEvent(
		com.amf.registration.model.MonitorEvent monitorEvent)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static com.amf.registration.model.MonitorEvent addEvent(
		long userId, java.lang.String ip, int eventType,
		com.liferay.portal.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().addEvent(userId, ip, eventType, serviceContext);
	}

	public static java.util.List<com.amf.registration.model.MonitorEvent> getEventsByType(
		int eventType, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEventsByType(eventType, start, end);
	}

	public static java.util.List<com.amf.registration.model.MonitorEvent> getEventsByTypeAndUser(
		int eventType, long userId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEventsByTypeAndUser(eventType, userId, start, end);
	}

	public static int getEventsByTypeAndUserCount(int eventType, long userId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEventsByTypeAndUserCount(eventType, userId);
	}

	public static int getEventsByTypeCount(int eventType)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getEventsByTypeCount(eventType);
	}
