...
/**
 * Provides the local service interface for MonitorEvent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author liferay
 * @see MonitorEventLocalServiceUtil
...
public interface MonitorEventLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MonitorEventLocalServiceUtil} to access the monitor event local service. Add custom service methods to {@link com.amf.registration.service.impl.MonitorEventLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
